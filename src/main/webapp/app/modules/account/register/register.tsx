...
import { Translate, translate, ValidatedField, ValidatedForm, isEmail } from 'react-translate';
...
export const RegisterPage = () => {
  ...
  return (
    <div className="register">
      <Row>
        <Col md="8">
          <h1 id="registerTitle" data-cy="registerTitle">
      ...
      <Row>
        <Col md="8">
          <ValidatedForm id="registerForm" onSubmit={handleValidSubmit}>
            <ValidatedField
              name="username"
            ...
            />
            <Button id="registerSubmit" color="primary" type="submit" data-cy="submit">
              <Translate contentKey="register.form.button">Register</Translate>
            </Button>
          </ValidatedForm>
          <p>&nbsp;</p>
          <Alert className="warningContainer" color="warning">
            <span>
